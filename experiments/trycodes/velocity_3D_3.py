...
streamline_tube = streamlines.tube(radius=2)
...
# 自定义透明度数组（整体偏透明，最大透明度0.3）
opacity_values = np.linspace(0.0, 0.3, 256)

# 创建 Plotter
plotter = pv.Plotter(window_size=(1400, 900))

# 温度体积 GPU 渲染
plotter.add_volume(theta_volume, scalars="theta", cmap="hot", opacity=opacity_values)
